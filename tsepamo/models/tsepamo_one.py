...
class TsepamoOne(UuidModelMixin, RecordIDModelMixin, CompleteFieldMixin, models.Model):
...
>>>>>>> 6f3baf8b103fa6fdd83cca52f1da267eedbf90f3
...
=======
    ...
    noattempt_consent_reason = models.CharField(
        ...
        choices=(
            ...
            ("4", "Delivery happened when RA was on leave"),
...
=======
        ...
        choices=(
            ...
            ("138", "ruggae on skin of skull (underlying abnormality of skull/brain)"),
            ...
            ("205", "Deformed face/face abnormalities (no further description)"),
            ...
            ("218", "growth on leg"),
            ("211", "hepatomegaly"),
            ("217", "large head (not hydrocephalus)"),
            ("187", "Legs not same length"),
            ("207", "Multiple abnormalities (no further description)"),
            ("213", "No motor control in hands (flopping hands)"),
            ("216", "occipital cyst"),
