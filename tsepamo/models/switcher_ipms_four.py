...
class SwitcherIpmsFour(UuidModelMixin, RecordIDModelMixin, CompleteFieldMixin, models.Model):
    ...
    class Meta:
        app_label = 'tsepamo'
        verbose_name = 'Switcher IPMS 4'
        verbose_name_plural = 'Switcher IPMS 4'
