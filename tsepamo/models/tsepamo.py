...
class Tsepamo(UuidModelMixin, RecordIDModelMixin, CompleteFieldMixin,models.Model):

  record_id = models.PositiveIntegerField(
  verbose_name="Record ID (site code, RA number, 5 DIGIT number)e.g. 100100001Site Codes:Princess Marina=10Nyangabwge=20Molepolole=30Maun=40Ghanzi=50Selebi Phikwe=60Serowe=70Mahalapye=80Bamalete Lutheran Hospital=90Palapye Primary Hospital=11Deborah Retief Hospaital=12 Kanye SDA Hospital=13Athlone Hospital=14Bobonong Primary Hospital=15Gumare Primary Hospital=16Goodhope Primary Hospital=17Tutume Primary Hospital=18Letlhakane Primary Hospital=19RA Number:OM=01GL=02DS=03 EM=04CD=05RM=06PM=07KF=08TM=09GM=11MO=12MD=13RZ=14GKM=15JM=16RS=17SL=18SDP=19KP=20DJ=21JL=22MT=23SM=24",
...
decimal_places=2, max_digits=8,
  ...
  max_length=1,
  choices=(('1', 'Nurse did not alert RA about the abnormality'), ('2', 'Delivery happened at night/after working hours'), ('3', 'Delivery happened on a weekend'), ('4', 'Delivery happened when RA was on leave, at a training or at a workshop'), ('5', 'Mother left the hospital before consent was attempted'), ('7', 'This is not an abnormality that we are collecting (for example: birthmark, undescended testes, hernia)'), ('6', 'Other')),
  help_text="", )
