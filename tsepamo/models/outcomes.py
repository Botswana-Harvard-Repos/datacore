...
class Outcomes(UuidModelMixin, RecordIDModelMixin, CompleteFieldMixin,
    ...
    delivery_site = models.CharField(
        ...
        max_length=2,
        choices=(('10', 'Princess Marina'), ('20', 'Nyangabwge'), ('30', 'Molepolole'), ('40', 'Maun'), ('50', 'Ghanzi'), ('60', 'Selebi Phikwe'), ('70', 'Serowe'), ('80', 'Mahalapye'), ('90', 'Bamalete Lutheran Hospital'), ('11', 'Palapye Primary Hospital'), ('12',
                 'Deborah Retief Hospaital'), ('13', 'Kanye SDA Hospital'), ('14', 'Athlone Hospital'), ('15', 'Bobonong Primary Hospital'), ('16', 'Gumare Primary Hospital'), ('17', 'Goodhope Primary Hospital'), ('18', 'Tutume Primary Hospital'), ('19', 'Letlhakane Primary Hospital')),
        help_text="", )
    ...
    child_status_phonecall = models.CharField(
        verbose_name="Child Current Status (per parent report)",
        max_length=1,
        choices=(('1', 'alive'), ('2', 'died')),
        help_text="", )

    cause_of_death = models.TextField(
        verbose_name="Circumstances of child death (including age, cause)",
        blank=True, null=True,
        help_text="", )
    ...
    imps_followup = models.TextField(
        verbose_name="IPMS/Records Follow-Up",
        blank=True, null=True,
        help_text="", )
