...
class PersonalIdentifiersFour(UuidModelMixin, RecordIDModelMixin, CompleteFieldMixin, models.Model):
    ...
    class Meta:
        app_label = 'tsepamo'
        verbose_name = 'Personal Identifiers 4'
        verbose_name_plural = 'Personal Identifiers 4'
